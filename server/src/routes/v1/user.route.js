...
router.get('/get-emails', auth(), userController.getUserEmailBySearch)
// router.get('/get-list-user-should-change-app-source', userController.getListUsersShouldChangeAppSource)
router.put('/update-logged-in-password', auth(), userController.updateLoggedInUserPassword)
router.get('/check-is-user-has-default-password', auth(), userController.checkIsUserHasDefaultPassword)
router.get('/get-list-tried-plans', userController.getListTriedPlansById)
router.get('/get-user-shopify-cart-id', userController.getUserShopifyCartIdById)
...
router.put('/onboarding', auth(), userController.updateOnBoarding)

router
  .route('/:userId')
  .get(validate(userValidation.getUser), userController.getUser) // auth('getUsers')
