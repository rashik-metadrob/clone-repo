...
export function Footer() {
  ...
  if(loading==true){
            ...
            <div className="row">
              <div style={{textAlign:'left'}} className="col-sm-12 col-md-6 col-lg-3">
                ...
                <img src={logo} className="foot-logo" alt="" width="250" />
                  <div className="address commonTextStyle">Create a digitally immersive experience for your customers</div>
              ...
              <div className="col-sm-12 col-md-6 col-lg-3">
                <div className="foot-item-center section--reveal">
                  ...
                  <ul style={{textAlign:'left'}}>
                    ...
                    <li style={{listStyleType:"none"}}> <Link to="/aboutus">About Us</Link></li>
                    <li style={{listStyleType:"none"}}> <Link to="/ContactUs">Contact Us</Link></li>
                    <li style={{listStyleType:"none"}}><Link to="/blogs">Blogs</Link></li>
                    <li style={{listStyleType:"none"}}><Link to="/PrivacyPolicy">Privacy Policy</Link></li>
                    <li style={{listStyleType:"none"}}><Link to="/TermsAndConditions">Terms And Conditions</Link></li>
                    <li style={{listStyleType:"none"}}><Link to="/shipingPolicy">Shipping And Delivery</Link></li>
                    {/* <li style={{listStyleType:"none"}}><a href="https://merchant.razorpay.com/policy/KKrl0qjupVDXsK/shipping">Merchant Policy</a></li> */}
                    <li style={{listStyleType:"none"}}><Link to="/CancellationRefundPolicy">Cancellation and Refund Policy</Link></li>
                    <li style={{listStyleType:"none"}}><Link to="/Disclaimer">Disclaimer</Link></li>
                    <li style={{listStyleType:"none"}}><Link to="/Sustainability">Sustainability</Link></li>
                    <li style={{listStyleType:"none"}}><Link to="/FAQ">FAQ</Link></li>
    ...
    // let blog_1= {url: '', title: '', lastPublishedAt: '2024-01-01'}
    // let blog_2= {url: '', title: '', lastPublishedAt: '2024-01-01'}
      ...
      <div className="full_content">
        <div className="container">
          <div className="row">
            ...
            <div className="col-sm-12 col-md-6 col-lg-3">
              <div className="foot-item-right section--reveal">
                <div className="title">FOLLOW US <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="18.071" height="31.313" viewBox="0 0 18.071 31.313">
                  <defs>
                    <linearGradient id="linear-gradient" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
                      <stop offset="0" stopColor="#16f6fe"/>
                      <stop offset="1" stopColor="#9904fc"/>
                ...
                <a href="https://www.facebook.com/metadrob/" target="_blank">
                <img src={fb} alt="" />
                </a>

                <a href="https://www.instagram.com/metadrob/" target="_blank">
                <img src={insta} alt="" />
                </a>

                 <a href="https://twitter.com/Metadrob_" target="_blank">

                <img src={twitter} alt="" />
                </a>

<a href="https://www.linkedin.com/company/metadrob" target="_blank">
                <img src={linkdin} alt=""/>
                </a>
                <a href="https://www.youtube.com/channel/UCbag-mWnqWToa4RKrrN8UYg" target="_blank">
                                <img src={yt} alt=""/>
                                </a>
                 </div>
                <div className="block">
